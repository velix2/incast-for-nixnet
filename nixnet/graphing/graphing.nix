...
let mkConfig = n: rtoMinUs: (import ../experiment.nix { inherit pkgs nixnet incast n rtoMinUs; lib = pkgs.lib; blockSizeBytes = 1024000 ; }) # 1024000 instead of 1000000 because we need to make sure that blockSizeBytes / 128 is a multiple of 1000
